    ...
    let card = Card {
        ...
        data: raw_card
            ...
            .map(|(k, v)| {
                let content = Content {
                    content: v.clone(),
                    hash: crate::utils::hash_string(&v),
                    format: None,
                };
                (k, content)
            })
...
mod tests {
    ...
    fn create_test_content(content: &str) -> Content {
        Content {
            content: content.to_string(),
            hash: crate::utils::hash_string(content),
            format: None,
        }
    }
    ...
    fn test_parse_card_data_basic() {
        ...
        assert_eq!(
            card.data.get("Front").map(|c| &c.content),
            Some(&"Question".to_string())
        );
        assert_eq!(
            card.data.get("Back").map(|c| &c.content),
            Some(&"Answer".to_string())
        );
        assert_eq!(card.deck, "Test");
        assert_eq!(card.tags, vec!["tag1", "tag2"]);
        assert_eq!(card.format, Some(FieldFormat::Svg));
    ...
    fn test_parse_card_data_with_defaults() {
        ...
        assert_eq!(card.format, None); // Default
    }
    ...
    fn test_validate_card_basic_valid() {
        let card = Card {
            ...
            data: [
                ("Front".to_string(), create_test_content("Q")),
                ("Back".to_string(), create_test_content("A")),
            ]
            .into(),
            deck: "Test".to_string(),
            tags: vec![],
    ...
    fn test_validate_card_empty_label() {
        let card = Card {
            label: "".to_string(),
            model: "Basic".to_string(),
            data: [("Front".to_string(), create_test_content("Q"))].into(),
            deck: "Test".to_string(),
            tags: vec![],
            rest: HashMap::new(),
            format: Some(FieldFormat::Svg),
    ...
    fn test_validate_card_basic_missing_fields() {
        let card = Card {
            label: "test".to_string(),
            model: "Basic".to_string(),
            data: [("Front".to_string(), create_test_content("Q"))].into(), // Missing Back
            deck: "Test".to_string(),
            tags: vec![],
            rest: HashMap::new(),
            format: Some(FieldFormat::Svg),
    ...
    fn test_apply_defaults() {
        ...
        let defaults = CardDefaults {
            ...
            data: Some([("Back".to_string(), create_test_content("DefaultBack"))].into()),
            rest: None,
        };
